...
import { useDeleteEmployee } from '../../../hooks/useMutation/useDeleteEmployee';
      ...
      >
        <div className="text-center">
          ...
          <p className="text-xs text-neutral-500 mb-4">
            Are you sure you want to delete <span className="font-bold text-neutral-900">{employeeName}</span>? This action <span className="font-bold text-red-500">cannot be undone</span>.
          </p>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 mb-5 text-left space-y-1.5">
            ...
            <ul className="text-[11px] text-amber-700 space-y-1 pl-5 list-disc">
              <li>The employee profile will be permanently removed.</li>
              <li>All personal and employment records will be deleted.</li>
              <li>This includes salary, bank details, documents, and notes.</li>
            </ul>
          </div>
          ...
          <div className="flex gap-2 justify-center">
            ...
            <button
              type="button"
              onClick={() => deleteEmployeeMutation(employeeId)}
              disabled={isDeleting}
