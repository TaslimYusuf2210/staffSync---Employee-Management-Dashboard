      ...
      <div className="bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[580px] transition-all duration-300">
        ...
        <div className="w-full md:w-1/2 bg-indigo-50/50 p-8 md:pr-16 flex flex-col items-center justify-center relative overflow-hidden border-b md:border-b-0 md:border-r border-slate-100">
          ...
          <div className="mt-8 text-center hidden md:block">
            ...
            <p className="text-slate-500 text-sm mt-1 max-w-xs mx-auto">Manage personnel schedules, tracks, and team metrics effortlessly.</p>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 p-8 md:py-12 md:pr-12 md:pl-20 flex flex-col justify-between">
          <div className="my-auto">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <button
                ...
                className="w-full py-3.5 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl shadow-lg shadow-indigo-100 hover:shadow-indigo-200 active:scale-[0.98] transition-all duration-150 cursor-pointer disabled:opacity-50"
              >
          ...
          {/* Social download buttons from mockup */}
          <div className="flex items-center justify-center gap-4 mt-8 pt-6 border-t border-slate-100">
            <a href="#appstore" className="flex items-center gap-2 px-4 py-2 bg-slate-900 hover:bg-slate-800 text-white rounded-lg transition-colors text-xs font-semibold">
            ...
            <a href="#playstore" className="flex items-center gap-2 px-4 py-2 bg-slate-900 hover:bg-slate-800 text-white rounded-lg transition-colors text-xs font-semibold">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
