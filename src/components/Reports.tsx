    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-neutral-500 mt-1">
            Analytical overview of workforce and payroll metrics.
          </p>{" "}
        </div>{" "}
        <div className="flex gap-2 shrink-0">
          ...
          <button
            ...
            className="px-3 py-2 bg-neutral-100 hover:bg-neutral-200 -[#faedcd] border border-neutral-200 rounded-xl text-xs font-bold text-neutral-700 transition-all cursor-pointer"
          >
            Export CSV
          </button>{" "}
          <button
          ...
          <button
            ...
            className="px-3 py-2 bg-[#ccd5ae] hover:bg-[#faedcd] text-neutral-950 rounded-xl text-xs font-bold transition-all cursor-pointer"
          >
            Export PDF
          </button>{" "}
        </div>{" "}
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {" "}
          <div className="bg-white -[#e9edc9] border border-neutral-200 -[#ccd5ae] rounded-2xl p-5 shadow-sm">
            {" "}
            ...
            {departments.map((dep) => {
              ...
              return (
                <div key={dep.id} className="flex items-center gap-4">
                  {" "}
                  <span className="text-xs font-bold text-neutral-600 w-28 shrink-0 truncate">
                    {dep.name}
                  </span>{" "}
                  <div className="flex-1 bg-neutral-100 -[#faedcd] rounded-full h-4 overflow-hidden">
                    {" "}
                    <div
                  ...
                  <span className="text-xs font-black text-neutral-950 w-16 text-right">
                    {count} ({pct}%)
                  </span>{" "}
                </div>
              );
        ...
        <div className="bg-white -[#e9edc9] border border-neutral-200 -[#ccd5ae] rounded-2xl p-6 shadow-sm">
          ...
          <div className="h-40 relative">
            ...
            >
              ...
              <path
                d="M0,28 L15,22 L30,24 L45,18 L60,14 L75,10 L100,5 L100,30 L0,30 Z"
                fill="url(#growthGrad)"
              />{" "}
              <path
                d="M0,28 L15,22 L30,24 L45,18 L60,14 L75,10 L100,5"
                fill="none"
                stroke="#171717"
                strokeWidth="1.5"
                className=""
              />{" "}
              {/* Data points */}{" "}
              <circle cx="0" cy="28" r="2" fill="#171717" className="" />{" "}
              <circle cx="15" cy="22" r="2" fill="#171717" className="" />{" "}
              <circle cx="30" cy="24" r="2" fill="#171717" className="" />{" "}
              <circle cx="45" cy="18" r="2" fill="#171717" className="" />{" "}
              <circle cx="60" cy="14" r="2" fill="#171717" className="" />{" "}
              <circle cx="75" cy="10" r="2" fill="#171717" className="" />{" "}
              <circle cx="100" cy="5" r="2" fill="#171717" className="" />{" "}
            </svg>{" "}
